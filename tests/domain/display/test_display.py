...
def test_display(
    ...
    assert PlainTextDisplay().to_text(event) == expected_plaintext_display
    assert RichTextDisplay().to_text(event) == expected_richtext_display
    assert JsonDisplay().to_text(event) == expected_json_display
